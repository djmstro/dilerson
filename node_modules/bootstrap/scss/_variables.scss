...
$font-family-sans-serif:      Roboto, "Helvetica Neue", Arial, FontAwesome !default;
...
$btn-disabled-opacity:        .85 !default;
...
$input-focus-border-color:              lighten(theme-color("primary"), 100%) !default;
...
$form-check-input-gutter:               1rem !default;
